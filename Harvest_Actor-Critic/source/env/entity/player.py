...
from source.env.systems.utility_funcs import return_view
...
class Agent(object):
    ...
    def compute_apples(self):
        apples = self.apples_this_turn
        self.apples_this_turn = 0
        return apples
