...
from source.env.core.constants import HARVEST_MAP
from source.env.core.map_env import ACTIONS, MapEnv
from source.env.entity import HarvestAgent
...
class HarvestEnv(MapEnv):
    ...
    def __init__(self, ascii_map=HARVEST_MAP, num_agents=1, render=False, norm=False):
        super().__init__(ascii_map, num_agents, render, norm=norm)
        self.apple_points = []
